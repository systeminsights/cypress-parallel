...
```
$ npm install @vimana/cypress-parallel
```
...
to configure `cypress-multi-reporters` with `@vimana/cypress-parallel/knapsack-reporter`
yourself.
...
```js
module.export = {
  /** @type {import("@vimana/cypress-parallel").UnweighedStrategy} */
